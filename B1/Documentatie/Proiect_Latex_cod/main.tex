...
\input{segmente/instalare si rulare/general}
    \subsection{alpha-beta-CROWN}
    \input{segmente/instalare si rulare/alpha-beta_CROWN}
    \subsection{NeuralSAT}
    \input{segmente/instalare si rulare/neuralSAT}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
